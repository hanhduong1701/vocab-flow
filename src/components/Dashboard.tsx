    ...
    return (
      <div ref={ref} className="space-y-6 animate-fade-in">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <Card className="cursor-pointer hover:shadow-soft transition-all group rounded-2xl" onClick={onShowImport}>
            <CardContent className="p-5 flex items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-muted-foreground">Upload a CSV file with your words</p>
              </div>
              <ChevronRight className="h-5 w-5 text-muted-foreground group-hover:translate-x-1 transition-transform" />
            </CardContent>
          </Card>

          <Card className="cursor-pointer hover:shadow-soft transition-all group rounded-2xl" onClick={onShowVocabulary}>
            <CardContent className="p-5 flex items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-muted-foreground">{stats.total} words in your library</p>
              </div>
              <ChevronRight className="h-5 w-5 text-muted-foreground group-hover:translate-x-1 transition-transform" />
            </CardContent>
          </Card>
          ...
          {sources.length > 0 && (
            <Card className="cursor-pointer hover:shadow-soft transition-all group rounded-2xl" onClick={onShowSources}>
              <CardContent className="p-5 flex items-center gap-4">
          ...
          {dailyStats.length > 0 && (
            <Card className="cursor-pointer hover:shadow-soft transition-all group rounded-2xl" onClick={onShowAnalytics}>
              <CardContent className="p-5 flex items-center gap-4">
