  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        option: "border-2 border-border bg-card hover:border-primary hover:bg-secondary text-left justify-start h-auto p-4",
        optionSelected: "border-2 border-primary bg-primary/10 text-left justify-start h-auto p-4",
        optionCorrect: "border-2 border-success bg-success/10 text-left justify-start h-auto p-4",
        optionIncorrect: "border-2 border-destructive bg-destructive/10 text-left justify-start h-auto p-4",
      },
      size: {
